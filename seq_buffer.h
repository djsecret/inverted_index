...
public:
    ...
    int read_data(char *dst, int length)
    {
        ...
        while(i < length && (!in.eof()))
        {
            ...
            if(in.gcount() == 0)  //the length of read data
            {
                break;
            }
            int k = 0;
...
//						case 'G': dst[i] = 5; ++i;break;
//						case 'H': dst[i] = 6; ++i;break;
//						case 'I': dst[i] = 7; ++i;break;
//						case 'K': dst[i] = 8; ++i;break;
//						case 'L': dst[i] = 9; ++i;break;
//						case 'M': dst[i] = 10; ++i;break;
//						case 'N': dst[i] = 11; ++i;break;
//						case 'P': dst[i] = 12; ++i;break;
//						case 'Q': dst[i] = 13; ++i;break;
//						case 'R': dst[i] = 14; ++i;break;
//						case 'S': dst[i] = 15; ++i;break;
//						case 'T': dst[i] = 16; ++i;break;
//						case 'V': dst[i] = 17; ++i;break;
//						case 'W': dst[i] = 18; ++i;break;
//						case 'Y': dst[i] = 19; ++i;break;
    ...
    {
        in.clear();
        in.seekg(std::ios::beg);//from begining of stream
    }
    bool eof()
    {
        return in.eof();
